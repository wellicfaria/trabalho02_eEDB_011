...
PATH_TRUSTED_API = '/workspaces/trabalho02_eEDB_011/data/trusted/api_reclamacao'
PATH_TRUSTED_FATO = '/workspaces/trabalho02_eEDB_011/data/trusted/reclamacao'
TABLE_MYSQL = 'DW.FT_INDICE_RECLAMACAO'

spark = SparkSession.builder.appName("REFINED_FT").config("spark.jars", "/workspaces/trabalho02_eEDB_011/drives/mysql-connector-java-8.0.22.jar").getOrCreate()
